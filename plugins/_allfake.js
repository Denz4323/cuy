...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         ['6285604500380', 'Denn', 'Creator BOT', 'dsaputr847@gmail.com', true],
         ['6285607069286', 'Denn-MD', 'Nomor BOT', 'dsaputr847@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "6285607069286-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
            ...
            message: { "liveLocationMessage": { "caption":"Denn-MultiDevice","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Denn-MultiDevice","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6285607069286-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "TES BOT", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
