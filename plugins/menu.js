...
│𖥂 ︎︎Platform: %platform
│𖥂︎︎ Type: Node.Js
│𖥂 ︎︎Uptime: %muptime
│𖥂 ︎︎Database:* %rtotalreg dari %totalreg
│
╰────────────────❖
 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
	...
	{title: `» Internet`, rowId: ".? internet", description: "╰► Yandek ga ada ya (≧▽≦)"},
...
//-------DOC TEMPLATE
    ...
    //------------------- 2BUTTON VID
   // conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c82d5c358495e8ef15916.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim(), footer: 'ᴍᴀᴅᴇ ᴡɪᴛʜ Denn-MD', templateButtons: [{ quickReplyButton: { displayText: 'Speedtest⚡', id: `${_p}speedtest` }}, { quickReplyButton: { displayText: 'Owner🎀', id: `${_p}owner` }} ] })
