...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/6285607069286' },
...
body: wm,
sourceUrl: 'http://wa.me/6285607069286', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
